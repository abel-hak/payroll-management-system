...
void clreol() {
    ...
    DWORD written;
    FillConsoleOutputCharacter(hStdout, ' ', csbi.dwSize.X - csbi.dwCursorPosition.X, csbi.dwCursorPosition, &written);
...
void EMPLOYEE::ADD_RECORD(int ecode, const char ename[26], const char eaddress[31], const char ephone[10], int d, int m, int y, const char edesig[16], char egrade, char ehouse, char econv, float eloan, float ebasic)
{
    fstream file;
    file.open("EMPLOYEE.DAT", ios::app | ios::binary);  // Open file in append mode and binary mode
    if (!file) {
    ...
    file.write((char*) this, sizeof(EMPLOYEE));  // Write the object to the file
    file.close();
}
...
void EMPLOYEE::SALARY_SLIP() {
    system("clear"); // For Linux/Unix; replace with "cls" for Windows
    int ecode;
    cout << "Enter code of the Employee (0 to exit): ";
    cin >> ecode;
    ...
    int d1 = ltm->tm_mday;
    int m1 = ltm->tm_mon + 1; // tm_mon is 0-based
    int y1 = 1900 + ltm->tm_year;
    ...
    cout << "             SALARY SLIP                     \n";
    cout << "---------------------------------------------\n";
    cout << "Date: " << d1 << " " << months[m1 - 1] << " " << y1 << "\n";
    cout << "Employee Name : " << name << "\n";
    cout << "Designation   : " << desig << "\n";
    cout << "Grade         : " << grade << "\n";

    float HRA = 0.0, CA = 0.0, DA = 0.0, PF = 0.0, LD = 0.0, OT = 0.0;
    float allowance = 0.0, deduction = 0.0, netsalary = 0.0;
    ...
    if (grade != 'E') {
        ...
        do {
            ...
            cin >> days;
        } while (!VALID_DATE(days, m1, y1));

        do {
            cout << "Enter number of overtime hours worked: ";
            cin >> hours;
        } while (hours < 0 || hours > 8);
    ...
    cout << "Basic Salary     : $" << fixed << setprecision(2) << basic << "\n";
    ...
    cout << "  - PF           : $" << PF << "\n";
    cout << "  - Loan Deduction: $" << LD << "\n";
    cout << "Net Salary       : $" << netsalary << "\n";

    cout << "---------------------------------------------\n";
    cout << "CASHIER                           EMPLOYEE\n";
    cout << "---------------------------------------------\n";
